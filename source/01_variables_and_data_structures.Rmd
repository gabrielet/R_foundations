...
In addition, there are many packages, e.g. *ggplot2*, *phyloseq*, *Vegan*, ..., that were created to extend the basic set of R functions for more specific tasks like DNA sequences analysis, gene enrichments analysis, network construction, advanced plotting, computing $\alpha$-diversity, and much more.
...
You can combine any kind of variable with `paste()` but results, sometimes, can be surprising (and may hide bugs)!
